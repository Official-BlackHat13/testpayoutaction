...
class Signup_Service:
    ...
    def SignUp(self):
        if(len(Client_model_service.Client_Model_Service.fetch_all_by_clientcode(self.user["client_code"],client_ip_address=self.client_ip_address,created_by="client added"))>0):
