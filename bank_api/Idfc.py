def uat_idfcPaymentAPI():    
    return "https://ESBUAT1RTN0140.idfcbank.com:9444/client/executeTransaction"
...
def prod_idfcEnquiryAPI():
    return "https://api.idfcbank.com/client/enquirePaymentsDebitTransaction"
